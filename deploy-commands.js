// deploy-commands.js
// Register guild-scoped slash commands (no dotenv required for Railway)
...
const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption(o => o.setName('user_id').setDescription('User ID to unban (paste the numeric ID)').setRequired(true))
    .addStringOption(o => o.setName('reason').setDescription('Reason').setRequired(false))
    .setDefaultMemberPermissions(adminDefaultPerm)
    .toJSON(),
