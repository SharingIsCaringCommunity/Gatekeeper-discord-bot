// deploy-commands.js
// Register guild slash commands (no dotenv required on Railway)
...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName('warnings')
    .setDescription('Check warnings (yourself or another member)')
  ...
  new SlashCommandBuilder()
    .setName('pardon')
    .setDescription('Unban a user by ID (resets warnings)')
  ...
  new SlashCommandBuilder()
    .setName('banlist')
    .setDescription('Show lifetime ban list (admin only)')
    .setDefaultMemberPermissions(adminDefaultPerm)
    .toJSON(),

  new SlashCommandBuilder()
    .setName('warnlist')
    .setDescription('Show warning list (admin only)')
    .setDefaultMemberPermissions(adminDefaultPerm)
    .toJSON(),
  ...
  new SlashCommandBuilder()
    .setName('addkeyword')
    .setDescription('Add blocked word (admin)')
  ...
  new SlashCommandBuilder()
    ...
    .setDescription('Remove blocked word (admin)')
  ...
  new SlashCommandBuilder()
    ...
    .setDescription('List blocked keywords (admin)')
    .setDefaultMemberPermissions(adminDefaultPerm)
    .toJSON(),
];
